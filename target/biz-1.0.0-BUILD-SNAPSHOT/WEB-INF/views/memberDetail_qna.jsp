...
<body>
    ...
    <section id="blog" class="padding-top">
        <div class="container"  >
				 ...
				 <caption>주문자 정보</caption> 
                    <tbody>
						<tr style="text-align: center;">
							...
							<td><button type="button" class="btn btn-default" id="qna" disabled="disabled">1:1문의 목록</button></td>
						</tr>                    	
                    </tbody>
                </table>   
			...
			<table class="table table-hover" >    
                                    <caption>
                                       <a href='/biz/member/detail/${email }/qna/1'>전체보기</a> (<span >${page.count }</span>) 
                                    </caption>              
                                 <thead>                  
                                    <tr class="">
                     	...
                     	<ul class="pagination" >
		                    <c:choose>
			                     <c:when test="${page.page gt 1 }" >
			                     	<li><a href='/biz/member/detail/${email }/qna/${page.page-1}'>left</a></li>
			                     </c:when>
			                     <c:otherwise >
			                     	<li><a href=''>left</a></li>
			                     </c:otherwise>
		                     ...
		                     <c:forEach begin="${page.pageStart }" end="${page.pageEnd }"  varStatus="status">
		                     	<li <c:out value="${status.current ==page.page?'class=active':'' }" /> ><a href='/biz/member/detail/${data[0].email }/qna/${status.current }'>${status.current }</a></li>
		                     </c:forEach>
		                     <c:choose>
			                     ...
			                     <c:otherwise >
			                     	<li><a href='/biz/member/detail/${email }/qna/${page.page+1}'>right</a></li>
			                     </c:otherwise>
		                     </c:choose>
                     </ul>
           			</div>
	    ...
	    if (r == true) {
        	...
        	str=str.substr(0,str.length-1);
				...
				//alert(contents)
				 ...
				 //location.replace("/biz/member/detail/${email }/qna/${page.page}"); 
		     	location.reload(true);
	    } else {
