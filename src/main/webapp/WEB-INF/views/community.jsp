            ...
            <div class="row">
                   ...
                   <br/>
                            <table class="table table-hover" >    
                                    <caption>
                                       <a href='/biz/community/1'>전체보기</a> (<span >${page.count }</span>) 
                     	...
                     	<ul class="pagination" >
		                    <c:choose>
			                     <c:when test="${page.page gt 1 }" >
			                     	<li><a href='/biz/community/${page.page-1 }${searchData}'>left</a></li>
			                     </c:when>
			                     <c:otherwise >
			                     	<li><a href=''>left</a></li>
			                     </c:otherwise>
		                     ...
		                     <c:forEach begin="${page.pageStart }" end="${page.pageEnd }"  varStatus="status">
		                     	<li <c:out value="${status.current ==page.page?'class=active':'' }" /> ><a href='/biz/community/${status.current }${searchData}'>${status.current }</a></li>
		                     </c:forEach>
		                     <c:choose>
			                     ...
			                     <c:otherwise >
			                     	<li><a href='/biz/community/${page.page+1 }${searchData}'>right</a></li>
			                     </c:otherwise>
		                     </c:choose>
                     </ul>
           			</div>
    	   ...
    	   var r = confirm("정말 삭제하시겠습니까?");
    	    if (r == true) {
		       	...
		       	str=str.substr(0,str.length-1);
					...
					location.replace("/biz/community/"+path);
    	    } else {
		...
		var text="";
		 ...
		 function searchFaq(page){
			 text=$("#txtSearch").val();
	       	...
	       	self.location="/biz/community/1?data="+text;
		}
